                ...
                <div class="admin-post">
                     ...
                     <table style="width:100%" border="1">
                      ...
                      <tr>
                        ...
                        <td><a href="admin_edit.jsp?title=<%=resultSet.getString("title") %>">Edit</a> | <a href="DeletePostAdmin?title=<%=resultSet.getString("title") %>">Delete</a> | <a href="PostPublish?title=<%=resultSet.getString("title") %>">publish</a></td>
                      </tr>
                      <% 
						}
